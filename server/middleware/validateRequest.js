...
module.exports = function(req, res, next) {
  ...
  var key = (req.params && req.params.x_key) || (req.query && req.query.x_key) || req.headers.x_email;
  var orgID = req.headers.x_orgID;
  if (token || key) {
    try {
      ...
      validateUser(key,orgID).then(function(dbUser){
        if (dbUser) {
